...
This means one can have an always-on zakad instance running, and another local zakad/zaka-qt instance which connects to this node and receives blocks from it.
