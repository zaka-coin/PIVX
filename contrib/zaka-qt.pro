...
RESOURCES += src/qt/zaka.qrc src/qt/zaka_locale.qrc

TRANSLATIONS += src/qt/locale/zaka_bg.ts \
                src/qt/locale/zaka_de.ts \
                src/qt/locale/zaka_en.ts \
                src/qt/locale/zaka_es.ts \
                src/qt/locale/zaka_fi.ts \
                src/qt/locale/zaka_fr.ts \
                src/qt/locale/zaka_it.ts \
                src/qt/locale/zaka_ja.ts \
                src/qt/locale/zaka_pl.ts \
                src/qt/locale/zaka_pt.ts \
                src/qt/locale/zaka_ru.ts \
                src/qt/locale/zaka_sk.ts \
                src/qt/locale/zaka_sv.ts \
                src/qt/locale/zaka_vi.ts \
                src/qt/locale/zaka_zh_CN.ts \
                src/qt/locale/zaka_zh_TW.ts
