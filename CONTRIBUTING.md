Contributing to ZAKA Core
============================

The ZAKA Core project operates an open contributor model where anyone is
...
The following applies to code changes to the ZAKA Core project, and is not to be
confused with overall ZAKA Network Protocol consensus changes.

Whether a pull request is merged into ZAKA Core rests with the project merge
...
Patches that change ZAKA consensus rules are considerably more involved than
...
Where a patch set proposes to change the ZAKA consensus, it must have been
...
The project leader is the release manager for each ZAKA Core release.
