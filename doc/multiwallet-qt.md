...
In order to support loading of multiple wallets in zaka-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is zaka.cpp.
...
Changes to zaka.cpp
----------------------
zaka.cpp is the entry point into zaka-qt, and as such, will require some minor modifications to provide hooks for
