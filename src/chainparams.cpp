...
static Checkpoints::MapCheckpoints mapCheckpoints =
    boost::assign::map_list_of(156, uint256("0x0000007b88f464b9e3f05d048373dedd2876a6253d75eb789cf8a4c6e14b9ca8"));
static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1521562447, // * UNIX timestamp of last checkpoint block
...
public:
    CMainParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // ZAKA: 1 day
        nTargetSpacing = 1 * 60;  // ZAKA: 1 minute
        nMaturity = 100;
        ...
        //vSeeds.push_back(CDNSSeedData("fuzzbawls.pw", "zaka.seed.fuzzbawls.pw"));     // Primary DNS Seeder from Fuzzbawls
        ...
        vSeeds.push_back(CDNSSeedData("192.168.100.25", "192.168.100.34"));           // Single node address
        vSeeds.push_back(CDNSSeedData("192.168.100.22", "192.168.100.31"));           // Single node address
        vSeeds.push_back(CDNSSeedData("192.168.100.20", "192.168.100.28"));
        ...
        nMintRequiredConfirmations = 1; //actual 20 by usama; //the maximum amount of confirmations until accumulated in 19
        nRequiredAccumulation = 1;
        nDefaultSecurityLevel = 100; //full security level for accumulators
        nZerocoinHeaderVersion = 4; //Block headers must be this version once zerocoin is active
        nBudget_Fee_Confirmations = 1; //actual 6 by usama; // Number of confirmations for the finalization fee
    }
    ...
    void Create_genesis_block(CBlock block, uint256 hash) {
        ...
        // different genesis.nTimes to create MainNet & TestNet Genesis Block
...
public:
    CTestNetParams()
    {
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("fuzzbawls.pw", "zaka-testnet.seed.fuzzbawls.pw"));
        vSeeds.push_back(CDNSSeedData("fuzzbawls.pw", "zaka-testnet.seed2.fuzzbawls.pw"));
        vSeeds.push_back(CDNSSeedData("s3v3nh4cks.ddns.net", "s3v3nh4cks.ddns.net"));
        vSeeds.push_back(CDNSSeedData("88.198.192.110", "88.198.192.110"));

        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet zaka addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet zaka script addresses start with '8' or '9'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet zaka BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet zaka BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet zaka BIP44 coin type is '1' (All coin's testnet default)
...
public:
    CRegTestParams()
    {
        ...
        nToCheckBlockUpgradeMajority = 1000;
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // ZAKA: 1 day
        nTargetSpacing = 1 * 60;        // ZAKA: 1 minutes
